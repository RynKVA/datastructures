...
class EntryHashMapTest {
    private final EntryHashMap<Character, Integer> emptyHashMap = new EntryHashMap<>();
    private final EntryHashMap<Character, Integer> hashMapWithTwoEntries = new EntryHashMap<>();
    private final EntryHashMap<String, Integer> stringKeyHashMap = new EntryHashMap<>();
    ...
    void testRemoveOnMapWithCollisionEntry() {
        EntryHashMap<Integer, Integer> collisionHashMap = new EntryHashMap<>();
    ...
    @Test
    @DisplayName("When default capacity (16) is full on seventy five percent (size = 12) then buckets capacity growing multiply double")
